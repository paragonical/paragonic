...
test-e2e-plugin:
	...
	@$(NEOVIM_LUA) $(E2E_DIR)/test_plugin_loading.lua
	@echo "Testing real filesystem operations..."
	@$(NEOVIM_LUA) $(E2E_DIR)/test_real_filesystem_operations_nvim.lua
	@echo "✓ Plugin E2E tests completed"

test-e2e-startup:
	@echo "=== Running E2E Tests: Startup ==="
	@echo "Testing AstroNvim startup..."
	@$(NEOVIM_LUA) $(E2E_DIR)/test_astronvim_startup.lua
