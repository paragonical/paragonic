...
function M.test_tool_relevance()
    ...
    local edit_relevance = mcp_tool_prompts.calculate_tool_relevance(edit_tool, editing_intent, TEST_CONFIG.test_context)
    ...
    local create_relevance = mcp_tool_prompts.calculate_tool_relevance(create_tool, creation_intent, TEST_CONFIG.test_context)
    ...
    local irrelevant_relevance = mcp_tool_prompts.calculate_tool_relevance(edit_tool, irrelevant_intent, TEST_CONFIG.test_context)
    ...
    assert(irrelevant_relevance < 1.0, "Edit tool should have lower relevance for search intent than for editing intent")
...
function M.test_prompt_construction()
    ...
    local disabled_prompt = mcp_tool_prompts.build_tool_awareness_prompt(TEST_CONFIG.test_message, TEST_CONFIG.test_context)
...
function M.test_configuration()
    ...
    local contextual_prompt = mcp_tool_prompts.build_tool_awareness_prompt(TEST_CONFIG.test_message, TEST_CONFIG.test_context)
