-- Minimal test for RPC reconnection functionality
-- This test just verifies the reconnection logic works
...
-- Test basic reconnection logic
local function test_basic_reconnection()
    print("Testing basic reconnection logic...")
...
local function run_all_tests()
    print("=== Testing RPC Reconnection Functionality (Minimal) ===")
...
if arg[0]:match("test_rpc_reconnection_minimal.lua$") then
    run_all_tests()
end
