...
local function test_data_validation()
	...
	assert(
		valid_entry.query and valid_entry.type and valid_entry.results_count,
		"Valid entry should have required fields"
	)
	assert(
		not (invalid_entry.query and invalid_entry.type and invalid_entry.results_count),
		"Invalid entry should be missing fields"
	)
	...
	assert(
		valid_saved.name and valid_saved.query and valid_saved.type,
		"Valid saved search should have required fields"
	)
	assert(
		not (invalid_saved.name and invalid_saved.query and invalid_saved.type),
		"Invalid saved search should be missing fields"
	)
