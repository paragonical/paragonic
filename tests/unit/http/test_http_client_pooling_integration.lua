...
local function test_connection_pool_metrics_accuracy()
    ...
    assert_test(after_get_metrics.available_connections == 0, "Available connections should be 0 after getting connection")
    ...
    assert_test(after_return_metrics.active_connections == 0, "Active connections should be 0 after returning connection")
    assert_test(after_return_metrics.available_connections == 1, "Available connections should be 1 after returning connection")
...
local function run_all_tests()
    ...
    -- Print test summary
    test_log("=========================================================")
    test_log(string.format("Test Summary: %d total, %d passed, %d failed", 
        test_state.test_count, test_state.passed_count, test_state.failed_count))
