...
local function test_low_load_scenario()
    ...
    assert_test(#load_result.errors == 0, 
        "No errors should occur in low load scenario with mock responses")
    assert_test(response_stats.avg < 100, 
        "Average response time should be under 100ms in low load with mock")
...
local function test_medium_load_scenario()
    ...
    assert_test(#load_result.errors == 0, 
        "No errors should occur in medium load scenario with mock responses")
    assert_test(response_stats.avg < 200, 
        "Average response time should be under 200ms in medium load with mock")
    assert_test(final_metrics.active_connections == 0, 
...
local function test_high_load_scenario()
    ...
    assert_test(#load_result.errors == 0, 
        "No errors should occur in high load scenario with mock responses")
    assert_test(response_stats.avg < 500, 
        "Average response time should be under 500ms in high load with mock")
    assert_test(final_metrics.active_connections == 0, 
...
local function test_stress_load_scenario()
    ...
    assert_test(#load_result.errors == 0, 
        "No errors should occur in stress load scenario with mock responses")
    assert_test(response_stats.avg < 1000, 
        "Average response time should be under 1000ms in stress load with mock")
    assert_test(final_metrics.active_connections == 0, 
...
local function run_all_load_tests()
    ...
    -- Print test summary
    test_log("============================================")
    test_log(string.format("Mock Load Test Summary: %d total, %d passed, %d failed", 
