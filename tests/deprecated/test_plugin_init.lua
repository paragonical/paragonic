...
-- Check if RPC client was created
local rpc_client = paragonic._get_rpc_client()
print("RPC client created:", rpc_client ~= nil)

if rpc_client then
	print("RPC client connected:", rpc_client:is_connected())
...
print("=== Plugin Init Test Complete ===")
