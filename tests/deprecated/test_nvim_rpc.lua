-- Debug test for RPC client in Neovim
local file = io.open("/tmp/nvim_rpc.log", "w")
if file then
    file:write("Starting RPC client debug test in Neovim...\n")
    ...
    file:write("=== RPC Client Debug Test Complete ===\n")
    file:close()
end 