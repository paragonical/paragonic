...
mod iragl_database_tests {
    ...
    async fn test_database_triggers_and_functions() {
        ...
        assert!(result.is_ok(), "update_updated_at_column function should exist");
        ...
        assert!(result.is_ok(), "update_knowledge_streams_updated_at trigger should exist");
        ...
        assert!(result.is_ok(), "update_content_associations_updated_at trigger should exist");
    ...
    async fn test_updated_at_trigger_functionality() {
        ...
        assert!(insert_result.is_ok(), "Should be able to insert test record");
    ...
    async fn test_check_constraints() {
        ...
        for (table, constraint) in constraints {
            ...
            assert!(result.is_ok(), "Check constraint {} should exist on table {}", constraint, table);
        }
        ...
        assert!(result.is_err(), "Invalid optimization_status should be rejected by check constraint");
        ...
        assert!(result.is_ok(), "Valid optimization_status should be accepted");
        
        // Clean up test data
        let cleanup_result = diesel::sql_query(
            "DELETE FROM knowledge_streams WHERE content_text = 'Test content'"
        ).execute(&mut conn);
