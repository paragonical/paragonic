            ...
            .await
        {
            Ok(response) => {
                ...
                if is_thinking_model {
                    ...
                    info!("   📤 Sending all {} chunks in single response (MCP standard)", chunks.len());
                    info!(
                        "   Response data: {}",
