...
function M.show_search_history()
    ...
    vim.api.nvim_buf_set_keymap(history_buf, "n", "<CR>", "<cmd>lua require('paragonic').repeat_search_from_history()<CR>", {noremap = true, silent = true})
    vim.api.nvim_buf_set_keymap(history_buf, "n", "d", "<cmd>lua require('paragonic').delete_from_search_history()<CR>", {noremap = true, silent = true})
...
function M.show_saved_searches()
    ...
    table.sort(saved_list, function(a, b) return a.saved.timestamp > b.saved.timestamp end)
    ...
    vim.api.nvim_buf_set_keymap(saved_buf, "n", "<CR>", "<cmd>lua require('paragonic').execute_saved_search_from_list()<CR>", {noremap = true, silent = true})
    vim.api.nvim_buf_set_keymap(saved_buf, "n", "d", "<cmd>lua require('paragonic').delete_saved_search_from_list()<CR>", {noremap = true, silent = true})
...
function M.display_search_results(results, title)
    ...
    vim.api.nvim_buf_set_keymap(results_buf, "n", "<CR>", "<cmd>lua require('paragonic').select_search_result()<CR>", {noremap = true, silent = true})
