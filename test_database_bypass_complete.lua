...
local function test_all_rpc_methods()
    ...
    local chat_cmd = 'echo \'{"jsonrpc":"2.0","method":"chat_completion","params":["Hello, what is 2+2?","llama2"],"id":1}\' | nc -w 15 127.0.0.1 3000'
    ...
    local info_cmd = 'echo \'{"jsonrpc":"2.0","method":"model_info","params":["llama2"],"id":1}\' | nc -w 10 127.0.0.1 3000'
